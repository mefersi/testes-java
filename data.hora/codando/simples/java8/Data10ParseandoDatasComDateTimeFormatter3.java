...
public class Data10ParseandoDatasComDateTimeFormatter3 {
	...
	public static void main(String[] args) throws ParseException {
		...
		// o dtf n�o � leniente, d� erro se n�o for passado um formato v�lido
...
//		LocalDate.parse("33/01/2022");
		...
		// RssolverrStyle.SMART por padr�o, no exemplo vai at� o �ltimo dia de fevereiro
		...
		// Fica mais restrito, gera uma exce��o por n�o haver o dia 31 de fev
