...
//		System.out.println("O doce de menor valor �: " + min);
//		
//		Optional<Doce> max = doces.stream()
//			.max(Doce::comparePorPreco);
//		System.out.println("O doce de maior valor �: " + max);

		// count
//		long quantidade = doces.stream()
//			.count();
//		System.out.println("A quantidade de doces �: " + quantidade);
...
//		System.out.println(listaDocesComBMenosUmReal);
		...
		List<Doce> listaDocesComB = doces.stream().filter(d -> d.getNome().charAt(0) == 'B')
				.collect(Collectors.toList());
