...
public class Data03ComparandoZonedDateTime {
	...
	public static void main(String[] args) {
		...
		// o equals vai comparar todas as informa��es, se tudo for igual retorna true se
		// um ponto for diferente retorna false
		System.out.println(date1.equals(date2));

		// o isequals compara se o instante � o mesmo, o timestamp
