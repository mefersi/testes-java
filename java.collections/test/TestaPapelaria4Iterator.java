...
public class TestaPapelaria4Iterator {
	...
	public static void main(String[] args) {
		...
		System.out.println("O s1 � equals impressao? " + s1.equals(impressao));
		System.out.print("O hashcode de s1 � igual ao hashcode de impressao? ");
		...
		System.out.println("------------------------------------------");
		System.out.println("Iterator servicos: ");

		Set<Servico> servicos = papelaria.getServicos();
