...
public class TesteDatas2 {
	...
	public static void main(String[] args) {
		 ...
		 * -----------------------------------------------------------------------------------------------------------------
		 * 
		 * Period - representa/armazena um espa�o de tempo baseado em datas, como dias,
		 * semanas, etc s� da para trabalhar com classes que representam data (dias,
		 * meses e anos)
		 * 
		 * Duration - representa/armazena um espa�o de tempo baseado em tempo, como
		 * horas, min, etc s� trabalha com classes relacionadas a tempo (horas, min e
		 * segundos)
		 */
		...
		System.out.println("Per�odo entre a minha data de nascimento e a data de agora: " + between);

		Period plusDays = between.plusDays(10);
		System.out.println("O per�odo anterior mais 10 dias: " + plusDays);

		// outra forma de obter um Period
		Period until = ldNow.until(ldJaque);
		System.out.println("Data de agora at� a data do meu nascimento usando o until: " + until);

		// adicionando um per�odo no localdate
