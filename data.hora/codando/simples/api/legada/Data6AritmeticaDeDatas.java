...
public class Data6AritmeticaDeDatas {
	...
	public static void main(String[] args) {
		...
		// para adicionar um periodo de tempo basta passar como abaixo, para subtrair
		// basta usar o sinal de menos "-"
		calendar.add(Calendar.DAY_OF_MONTH, 5);
		calendar.add(Calendar.HOUR_OF_DAY, 6);
		System.out.println(calendar.getTime());

		// se adicionar days of month ou seja, dias numa data, essa pode, dependendo dos
		// dias adicionados, pular para outros meses
		Calendar calendar2 = Calendar.getInstance();
		calendar2.set(2022, Calendar.JANUARY, 31, 0, 0, 0);
		calendar2.add(Calendar.DAY_OF_MONTH, 31);
		System.out.println(calendar2.getTime());

		// se quiser incrementar s� o m�s melhor adicionar no campo month
		...
		// a unica forma de calcular o periodo de tempo entre uma data e outra �
		// subtraindo o timestamp de uma pela outra
